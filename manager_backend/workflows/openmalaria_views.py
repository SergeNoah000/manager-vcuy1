...
def submit_openmalaria_workflow_view(request, workflow_id):
    ...
    try:
        ...
        num_tasks = 10 # request.data.get('num_tasks')
        population_per_task = 1000 # request.data.get('population_per_task')
        ...
        def process_workflow_async():
            ...
            try:
                ...
                if response.get('volunteers'):
                    ...
                    #         input_files = [{
                    #             'path': file_path,
                    #             'size': os.path.getsize(os.path.join(workflow.executable_path, file_path)) if os.path.exists(os.path.join(workflow.executable_path, file_path)) else 0
